...
Conduct a thorough security audit checking for OWASP Top 1tdd-guide vulnerabilities, hardcoded secrets, and unsafe patterns.
...
Completes the following security analysis:
...
- **Automate** - Run security scans in CI/CD workflows
